...
import id.co.picklon.utils.SecretInterceptor;
...
public class AppModule {
    ...
    @Provides
    @Singleton
    OkHttpClient provideOkHttpClient(PicklonApplication app,
                                     HttpLoggingInterceptor interceptor,
                                     SecretInterceptor secretInterceptor) {
        return createOkHttpClient(app, interceptor, secretInterceptor).build();
    }
    ...
    @Provides
    @Singleton
    SecretInterceptor provideSecretInterceptor() {
        return new SecretInterceptor();
    }

    private static OkHttpClient.Builder createOkHttpClient(PicklonApplication app,
                                                           HttpLoggingInterceptor interceptor,
                                                           SecretInterceptor secretInterceptor) {
